...
class CreatureSyncController extends Controller
{
    ...
    public function upsert(Request $request)
    {
        $data = $request->validate([
            ...
            'entry.slug' => ['nullable', 'string', 'max:255'],
            'entry.classification' => ['required', 'string', 'max:255'],
            'entry.category' => ['nullable', 'string', 'max:255'],
            'entry.threat_level' => ['required', 'string', 'max:255'],
            'entry.height' => ['nullable', 'string', 'max:255'],
            'entry.description' => ['required', 'string'],
            'entry.last_record' => ['nullable', 'string'],
            'entry.status' => ['nullable', 'string', 'max:255'],
            'entry.final_combat_scenario' => ['nullable', 'string'],
            'entry.main_image_path' => ['nullable', 'string', 'max:255'],
            'entry.primary_color' => ['nullable', 'string', 'max:20'],
            'entry.accent_color' => ['nullable', 'string', 'max:20'],
            'entry.parchment_tone' => ['nullable', 'string', 'max:20'],
            'entry.frame_style' => ['nullable', 'string', 'max:255'],
            'entry.published_at' => ['nullable', 'date'],
            'entry.theme_key' => ['nullable', Rule::exists('dossier_themes', 'key')],
            'entry.origin' => ['nullable', 'array'],
            'entry.origin.universe' => ['nullable', 'string', 'max:255'],
            'entry.origin.game' => ['nullable', 'string', 'max:255'],
            'entry.origin.campaign' => ['nullable', 'string', 'max:255'],
            'entry.origin.source' => ['nullable', 'string', 'max:255'],
            'entry.origin.region' => ['nullable', 'string', 'max:255'],
            'entry.subtitles' => ['nullable', 'array', 'max:3'],
            'entry.subtitles.*' => ['string', 'max:255'],
            'entry.affinities' => ['nullable', 'array'],
            'entry.affinities.*' => ['string', 'max:255'],
            'entry.habitats' => ['nullable', 'array'],
            'entry.habitats.*' => ['string', 'max:255'],
            'entry.behaviors' => ['nullable', 'array'],
            'entry.behaviors.*' => ['string', 'max:255'],
            'entry.abilities' => ['nullable', 'array'],
            'entry.abilities.*.name' => ['required_with:entry.abilities', 'string', 'max:255'],
            'entry.abilities.*.description' => ['required_with:entry.abilities', 'string'],
            'entry.techniques' => ['nullable', 'array'],
            'entry.techniques.*.name' => ['required_with:entry.techniques', 'string', 'max:255'],
            'entry.techniques.*.description' => ['required_with:entry.techniques', 'string'],
            'entry.weaknesses' => ['nullable', 'array'],
            'entry.weaknesses.*.description' => ['required_with:entry.weaknesses', 'string'],
            'entry.loot' => ['nullable', 'array'],
            'entry.loot.*.name' => ['required_with:entry.loot', 'string', 'max:255'],
            'entry.loot.*.description' => ['required_with:entry.loot', 'string'],
            'entry.loot.*.rarity' => ['nullable', 'string', 'max:255'],
            'entry.stats' => ['nullable', 'array'],
            'entry.stats.*.name' => ['required_with:entry.stats', 'string', 'max:255'],
            'entry.stats.*.value' => ['required_with:entry.stats', 'integer', 'between:0,100'],
            'entry.stats.*.value_label' => ['nullable', 'string', 'max:255'],
            'entry.vignettes' => ['nullable', 'array'],
            'entry.vignettes.*.title' => ['required_with:entry.vignettes', 'string', 'max:255'],
            'entry.vignettes.*.description' => ['nullable', 'string'],
            'entry.vignettes.*.image_path' => ['nullable', 'string', 'max:255'],
            'entry.scholar_notes' => ['nullable', 'array'],
            'entry.scholar_notes.*.note' => ['required_with:entry.scholar_notes', 'string'],
        ]);
